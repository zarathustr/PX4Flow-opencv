...
JNIEXPORT void JNICALL Java_org_opencv_core_Core_drawMarker_10 (JNIEnv*, jclass, jlong, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble, jint, jint, jint, jint);

JNIEXPORT void JNICALL Java_org_opencv_core_Core_drawMarker_10
...
{
    static const char method_name[] = "core::drawMarker_10()";
    try {
        LOGD("%s", method_name);
        Mat& img = *((Mat*)img_nativeObj);
...
JNIEXPORT void JNICALL Java_org_opencv_core_Core_drawMarker_11 (JNIEnv*, jclass, jlong, jdouble, jdouble, jdouble, jdouble, jdouble, jdouble);

JNIEXPORT void JNICALL Java_org_opencv_core_Core_drawMarker_11
...
{
    static const char method_name[] = "core::drawMarker_11()";
    try {
        LOGD("%s", method_name);
        Mat& img = *((Mat*)img_nativeObj);
        Point position((int)position_x, (int)position_y);
